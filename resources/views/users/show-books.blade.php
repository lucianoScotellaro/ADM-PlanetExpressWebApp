...
<div class="flex flex-row">
                    ...
                    <div class="flex flex-row min-w-0 gap-x-4">
                        ...
                        <div class="flex basis-1/6 justify-items-center items-center">
                            <div class="flex flex-col w-2/3">
                                ...
                                <x-form-button form="delete-book-{{ $book->ISBN }}-on-loan">Elimina dai prestabili</x-form-button>
                                <form action="/users/{{ $user->id }}/books/{{ $book->ISBN }}/ontrade" method="POST" id="delete-book-{{ $book->ISBN }}-on-trade" class="hidden">
                                    @csrf
                                    @method('DELETE')
                                </form>
                                <x-form-button form="delete-book-{{ $book->ISBN }}-on-trade">Elimina dagli scambiabili</x-form-button>
    ...
    <x-button href="/users/user/books/create">Aggiungi libro</x-button>
</div>
</body>
</html>
